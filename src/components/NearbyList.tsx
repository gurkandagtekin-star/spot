...
const createStyles = (colors: ColorTokens) =>
  StyleSheet.create({
    ...
    chev: { color: 'rgba(255,255,255,0.72)', fontWeight: '800', fontSize: 14 },
    ...
    name: { fontWeight: '800', color: '#fff', fontSize: 12 },
    text: { color: 'rgba(255,255,255,0.78)', fontSize: 11, marginTop: 1 },
    metaCol: { alignItems: 'flex-end' },
    dist: { color: colors.teal, fontWeight: '800', fontSize: 11 },
    time: { color: 'rgba(255,255,255,0.62)', fontSize: 10, fontWeight: '600', marginTop: 1 },
  });
